...
void main() {
  group("Form Button Tests", () {
    testWidgets("Enabled State", (WidgetTester tester) async {
      await tester.pumpWidget(
        Theme(
          ...
          child: const Directionality(
            ...
            child: FormButton(disabled: false, formText: "Next"),
          ),
        ),
      );
      ...
      expect(
        tester
            .firstWidget<AnimatedDefaultTextStyle>(find.byType(AnimatedDefaultTextStyle))
            .style
            .color,
        Colors.white,
      );
      ...
      expect(
        (tester.firstWidget<AnimatedContainer>(find.byType(AnimatedContainer)).decoration
                as BoxDecoration)
            .color,
      ...
      await tester.pumpWidget(
        const MediaQuery(
          ...
          child: Directionality(
            textDirection: TextDirection.ltr,
            child: FormButton(disabled: true, formText: "Next"),
          ),
        ),
      );
