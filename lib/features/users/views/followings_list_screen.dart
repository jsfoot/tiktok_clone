...
class FollowingsListScreen extends ConsumerStatefulWidget {
  ...
  static const String routeURL = "/followingsList";
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _FollowingsListScreenState();
}

class _FollowingsListScreenState extends ConsumerState<FollowingsListScreen> {
